...
public class Node extends ListItem {
    ...
    int compareTo(ListItem item){
        return item.toString().compareTo(item.getValue().toString());
    }
}
/**
 ...
 -  compareTo(), takes a ListItem and compares it to the ListItem that called this method.
    ...
    then it should return a number greater than zero. If vice versa, then it should return a number less
    than zero, and zero if equal.
 **/
